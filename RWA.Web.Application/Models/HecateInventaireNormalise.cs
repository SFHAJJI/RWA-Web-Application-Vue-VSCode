...
public partial class HecateInventaireNormalise
{
    ...
    public HecateInventaireNormaliseDto ToDto()
    {
        return new HecateInventaireNormaliseDto
        {
            ...
            DateFinContrat = this.DateFinContrat?.ToString("yyyy-MM-dd") ?? string.Empty,
            IdentifiantOrigine = this.IdentifiantOrigine,
            ...
            DateMaturite = this.DateMaturite?.ToString("yyyy-MM-dd") ?? string.Empty,
            DateExpiration = this.DateExpiration?.ToString("yyyy-MM-dd") ?? string.Empty,
