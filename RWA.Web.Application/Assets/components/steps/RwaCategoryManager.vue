            ...
            <v-card-text>
                ...
                <div v-else>
                    <v-form ref="form" v-model="formValid">
                        <div v-if="loading">
                            <v-skeleton-loader type="table" :loading="loading" aria-busy="true" />
                        </div>
                        <div v-else-if="rows.length === 0" class="text-center py-8">
                            ...
                            <p class="text-body-2 grey--text">The system is processing category mappings via SignalR.</p>
                            ...
                            >
                                                ...
                                                <template #item.categorieRwa="{ item }">
                                                    <div style="display:flex; gap:8px; align-items:center">
                                                        <v-select
                                                            :items="categorieRwaOptions"
                                                            v-model="selectedCategorieRwa[getItemKey(item)]"
                                                            item-title="title"
                                                            item-value="value"
                                                            variant="outlined"
                                                            density="compact"
                                                            hide-details
                                                            class="rwa-select"
                                                            placeholder="Select RWA Category"
                                                ...
                                                <template #item.typeBloomberg="{ item }">
                                                    <div style="display:flex; gap:8px; align-items:center">
                                                        <v-select
                                                            :items="typeBloombergOptions"
                                                            v-model="selectedTypeBloomberg[getItemKey(item)]"
                                                            item-title="title"
                                                            item-value="value"
                                                            variant="outlined"
                                                            density="compact"
                                                            hide-details
                                                            class="rwa-select"
                                                            placeholder="Select Bloomberg Type (Optional)"
                            ...
                            <v-row class="mt-6">
                                        <v-col cols="12" class="d-flex justify-space-between align-center">
                                            <div class="d-flex gap-3">
                                                ...
                                                >
                                                    <v-icon left>{{ loading ? 'mdi-loading mdi-spin' : 'mdi-check-circle' }}</v-icon>
                                                ...
                                                <v-btn
                                                    ...
                                                    large
                                                    @click="reload" 
                                                    aria-label="Reload missing rows"
                                                >
                                            ...
                                            <div v-if="filteredRows.length > 0" class="text-caption text--secondary">
                                                ...
                                                <span v-if="search && filteredRows.length !== rows.length" class="ml-2 text--disabled">
