...
// Copy fonts into the Vite `public` folder so the dev server serves them
// and the Vite build will copy them to the final `wwwroot` (outDir).
const outFontsDir = path.join(projectRoot, 'Assets', 'public', 'fonts');
